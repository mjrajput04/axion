  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
        ...
        <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#737373]">Querying Entities...</p>
      </div>
    );
  }
    ...
    <div className="space-y-10">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-[#737373] font-medium">Manage your organizational entities and compliance boundaries. (Ref: Doc 16 §12)</p>
        </div>
